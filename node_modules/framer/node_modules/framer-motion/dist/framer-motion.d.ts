 ...
 * @public
 */
export declare function animate<V>(from: MotionValue<V> | V, to: V | V[], transition?: AnimationOptions_2<V>): PlaybackControls;
 ...
 * @public
 */
export declare class AnimateSharedLayout extends React.Component<SharedLayoutProps, {}, VisualElementTree> {
...
declare type AnimationCompleteListener = () => void;
...
declare type AnimationOptions_2<V> = (Tween | Spring) & PlaybackLifecycles<V> & {
    delay?: number;
    type?: "tween" | "spring";
};
...
declare interface AnimationState {
    setProps: (props: MotionProps, options?: AnimationOptions, type?: AnimationType) => Promise<any>;
 ...
 * @public
 */
export declare function createDomMotionComponent<T extends keyof MotionComponents>(key: T): MotionComponents[T];
...
declare interface CrossfadeState {
 ...
 * @public
 */
export declare function useAnimation(): import("./AnimationControls").AnimationControls;
...
declare type UseVisualElement<E, P = MotionProps> = (Component: string | React_2.ComponentType<P>, props: MotionProps & P, isStatic?: boolean, ref?: Ref<E>) => VisualElementTree;
...
declare type ViewportBoxListener = (box: AxisBox2D) => void;
...
export declare interface VisualElement<Instance = any, MutableState = any> extends LifecycleManager {
    depth: number;
...
export declare const visualElement: <Instance, MutableState, Options>({ createRenderState, build, getBaseTarget, makeTargetAnimatable, measureViewportBox, onMount, render: renderInstance, readValueFromInstance, resetTransform, restoreTransform, removeValueFromMutableState, scrapeMotionValuesFromProps, }: VisualElementConfig<Instance, MutableState, Options>) => ({ parent, variantParent, ref: externalRef, props, isStatic, snapshot, presenceId, blockInitialAnimation, }: VisualElementOptions<Instance>, options: Options) => VisualElement<Instance, any>;

declare interface VisualElementConfig<Instance, MutableState, Options> {
    createRenderState(): MutableState;
    onMount?: (element: VisualElement<Instance>, instance: Instance, mutableState: MutableState) => void;
    getBaseTarget?(props: MotionProps, key: string): string | number | undefined | MotionValue;
    build(visualElement: VisualElement<Instance>, renderState: MutableState, visualState: VisualState, layoutState: LayoutState, options: Options, props: MotionProps): void;
...
declare type VisualElementOptions<Instance> = {
    ref?: Ref<Instance>;
...
declare interface VisualElementTree {
    parent?: VisualElement;
